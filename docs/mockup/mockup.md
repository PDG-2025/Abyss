# Description des Mockups - Projet Abyss
...
![alt text](./computer/Group%209.png "Title")
...
- Vitesse : 0 m/min
  ![alt text](./computer/Group%206.png "Title")
...
- Profondeur : 18.6 m
- Vitesse de remontée : 9 m/min
  ![alt text](./computer/Group%205.png "Title")
...
- Nitrox avec le choix du pourcentage d'O²
  ![alt text](./computer/Group%2010.png "Title")
...
- Logs disponibles : 14 plongées
  ![alt text](./computer/Group%203.png "Title")
...
- Alarmes : Vitesse / MOD
- Compas : calibré
  ![alt text](./computer/Group%208.png "Title")
